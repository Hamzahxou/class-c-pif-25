...
export default function Header2({ navItems }: { navItems: NavItem[] }) {
            ...
            >
              ...
              >
                <div className="relative">
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl  overflow-hidden shadow-2xl shadow-black">
                    {/* bg-linear-to-b from-yellow-500 via-rose-600 to-rose-700 */}
