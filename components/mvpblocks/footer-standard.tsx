  ...
  socialLinks: [
    {
      icon: Music2,
      label: "Tiktok",
      href: "https://www.tiktok.com/@classc_pifutm25",
    },
    {
      icon: Instagram,
      label: "Instagram",
      href: "https://www.instagram.com/classc_pifutm25",
    },
  ],
});
        ...
        <div className="container m-auto grid grid-cols-1 gap-12 py-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <p className="text-muted-foreground max-w-md">
              Website resmi Pendidikan Informatika 1C. Tempat kita belajar,
